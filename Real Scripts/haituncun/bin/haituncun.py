...
def outputfile(dir,filename,data,start_time,end_time):
    ...
    with xlsxwriter.Workbook(real_file_name) as file:
        ...
        report = "从"+start_time+"到"+end_time+"关于"+filename+"的妥投报告"
...
def exportToFinishedExcel(customer_name,end_time):
...
and cr.dadate BETWEEN '{}' and '{}'
group by cr.cnum;
        '''.format("','".join(jerry_set),start_time,end_time)
    ...
    return outputfile("Finished",customer_name+"~"+start_time+"~"+end_time+".xlsx",result_data,start_time,end_time)
...
if __name__ == '__main__':
    ...
    file.append(exportToFinishedExcel("AuMelHaituncun",end_time));
    file.append(exportToFinishedExcel("AuSydHaituncun",end_time));
    file.append(exportToFinishedExcel("RY",end_time));
